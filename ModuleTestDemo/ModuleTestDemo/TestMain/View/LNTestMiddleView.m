...
@implementation LNTestMiddleView

static LNTestMiddleView *_shareInstance;

+ (instancetype)shareInstance {
    if (_shareInstance == nil) {
        _shareInstance = [LNTestMiddleView middleView];
    }
    return _shareInstance;
}
+ (instancetype)middleView {
    
    LNTestMiddleView *middleView = [[[NSBundle bundleForClass:self] loadNibNamed:@"LNTestMiddleView" owner:nil options:nil] firstObject];
    return middleView;
}
