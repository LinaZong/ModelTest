...
@interface LNTestTabBar()


@property (nonatomic, weak) LNTestMiddleView *middleView;

@end

@implementation LNTestTabBar
...
/**
 ...
 @return 中间的按钮控件
 */
- (LNTestMiddleView *)middleView {
    if (_middleView == nil) {
        LNTestMiddleView *middleView = [LNTestMiddleView shareInstance];
