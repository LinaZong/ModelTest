...
-(void)addRootViewController{
    ...
    LNTestTabBarController * rootVC = [LNTestTabBarController tabBarControllerWithAddChildVCsBlock:^(LNTestTabBarController * tabBarC){
    ...
    LNTestTabBar * tabbar = (LNTestTabBar *)rootVC.tabBar;
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"ModuleTestDemo"];
